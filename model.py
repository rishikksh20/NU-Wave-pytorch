...
class NUWave(nn.Module):
    def __init__(self, params):
        ...
        self.conditioner_projection = Conv1d(params.input_channels, params.residual_channels, 1)
        ...
        self.output_projection = Conv1d(params.residual_channels, params.output_channels, 1)

...
class NUWaveLearner:
  ...
  def _write_summary(self, step, features, loss):
    ...
    writer.add_audio('feature/audio', features['audio'][0], step, sample_rate=self.params.new_sample_rate)
    writer.add_audio('feature/lr_audio', features['lr_audio'][0], step, sample_rate=self.params.sample_rate)
...
def train(args, params):
  dataset = create_dataloader(params, True,)
...
def train_distributed(replica_id, replica_count, port, args, params):
  ...
  _train_impl(replica_id, model, create_dataloader(params, True, is_distributed=True), args, params)
